...
from utilities import type_deferred_broker_type, type_loan_documents_mc
...
knacklyToHotDocs = {
    ...
    "features": {
        ...
        "construction": {
            ...
            "Contractor": parse_Address(
                "Contractor Street Address TE",
                "Contractor City TE",
                "Contractor State MC",
                "Contractor Zip TE",
            ),
            "Completion": parse_Completion(
                "Construction Contract Percent NU", "Construction Contract Days NU"
            ),
            "IsDesignContract": parse_primitive("Construction Design Contract TF"),
            "Designer": parse_Address(
                "Designer Street Address TE",
                "Designer City TE",
                "Designer State MC",
                "Designer Zip TE",
            ),
            "isThirdPartyConstructionGuaranty": parse_primitive(
                "Guaranty of Completion TF"
            ),
            "isAssigisBrokernmentOfPermits": parse_primitive(
                "Assignment of Permits TF"
            ),
            "completionGuarantors": parse_completionGuarantors(
                "Construction Guaranty Name TX"
            ),
        },
        "loanFeatures": {
            ...
            "deferredOriginationDollars": parse_primitive(
                "Deferred Origination Fee NU"
            ),
            "deferredOriginationPercent": parse_primitive(
                "Deferred Origination Fee Percent NU"
            ),
        },
        "reserves": {
            ...
            "DebtServiceType": parse_DebtServiceType(
                "Interest Reserve TF", "Interest Reserve Months TF"
            ),
    ...
    "lenderInformation": {
        ...
        ),  # This doesn't include CFL license for each lender because it isn't supported in HD
        ...
        "Notice": parse_Address(
            "Lender Street Address TE",
            "Lender City TE",
            "Lender State MC",
            "Lender Zip Code TE",
        ),
    ...
    "docsAdd": {
        ...
        "isIntercreditor": parse_isIntercreditors("Loan Documents MC"),
        "intercreditorAgreements_list": {  # This needs to be an array as well!!!!!
            ...
            "intercreditorAgreements_list": parse_intercreditors_list(
