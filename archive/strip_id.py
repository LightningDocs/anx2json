...
def init_argparse() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        "--replace",
        action="store_true",
        help="replace the provided file instead of creating a new file",
    )
    return parser
...
def main():
    ...
    try:
        ...
        print(
            f"The file '{filename}' does not exist. Are you sure you are typing it correctly?"
        )
        sys.exit()
    except Exception as e:
        print(
            f"Could not parse {filename} into valid JSON. Make sure your file is formatted properly."
        )
        sys.exit()
