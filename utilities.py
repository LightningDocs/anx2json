def type_address(street: str = None, city: str = None, state: str = None, zip: str = None, county: str = None) -> dict:
...
def type_debt_service_type(interest_reserve_tf: bool, interest_reserve_months_tf: bool) -> str:
...
def type_security_ownership_spreadsheet(name: str = None, is_individual: bool = None, signer_for_pledgor: str = None, title: str = None, state: str = None):
    x = {"name": name, "isIndividual": is_individual, "signerForPledgor": signer_for_pledgor, "title": title, "state": state}
    y = {key: value for key, value in x.items() if value is not None}
    return y

def type_security_csa_debtor_spreadsheet(debtor_name_with_vesting: str = None, is_individual: bool = None, title: str = None, signer_for_debtor: str = None, state: str = None):
    x = {"debtorNameWithVesting": debtor_name_with_vesting, "isIndividual": is_individual, "title": title, "signerForDebtor": signer_for_debtor, "state": state}
    y = {key: value for key, value in x.items() if value is not None}
    return y
