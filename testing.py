...
# filename = "./examples/hotdocs/hotdocs_example.anx"
# filename = "./examples/hotdocs/hotdocs_blank3.anx"
...
def main():
    ...
    knacklyToHotDocs2 = {
        ...
        "lenderInformation": {
            ...
            "MultipleLenders": parse_MultipleLenders("Lender Name TE", "Lender Invest Amount NU"),
        },
    ...
    # pprint(remove_none_values(knacklyToHotDocs2))
    x = knacklyToHotDocs2
    # x = remove_none_values(x)
    # pprint(knacklyToHotDocs2)
